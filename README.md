...
1) <b>Пользователь</b>
   ...
   * Уточнение некоторых деталей заказа(время доставки)
   * Изменение списка товаров
   * Получение уведомления о том, что есть незавершенный заказ
   * Выбор времени доставки
   * Произведение оплаты после выбора параметров доставки
   * Оплата заказа
...
2) <b>Магазин</b>
   ...
   * Если доставка не была выполнена вовремя, то производится рефанд стоимости.
<br><br>
3) <b>Сообщение</b>
...
4) <b>Исполнитель(курьерская служба)</b>
   * Магазин передает обязанности по доставке товара внешнему исполнителю. Внешняя система здесь эмулирует работу этого исполнителя — курьерской службы.
   * После оплаты заказа система передает информацию системе доставки.
